		...
		if (navigation.getParam('previousScreen') === 'UserInfo') {
			...
			if (
				...
				setNotificationContent({
					error: true,
					message: 'Żadne pole nie zostało zmienione',
				});
		...
		<ScrollView contentContainerStyle={{ flexGrow: 1 }}>
			...
			>
				...
				<Container spread="top" composition="comapct">
					<UserFirstnameInput placeholder={phName} changeHandler={setName} />
					...
					<UserLoginInput placeholder={phLogin} changeHandler={setLogin} />

					<UserEmailInput placeholder={phEmail} changeHandler={setEmail} />
