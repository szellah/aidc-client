...
function Sres_promise(
    ...
    return new Promise((resolve, reject) => {
        ...
        pool.query(
            `UPDATE articles SET Name = '${name}', Surname = '${surname}', Login = '${login}', Password = '${password}', Email = '${email}', Rank = '${rank}', State = '${state}', InventoryId = '${inventoryid}', Personaluseid = '${personaluseid}' WHERE AccountId = ${accountid}`,
            (error) => {
