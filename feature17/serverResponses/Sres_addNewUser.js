...
function Sres_promise(
    ...
    return new Promise((resolve, reject) => {
       ...
       // ustawienie daty rrrr-mm-dd hh:mm:ss
        ...
        pool.query(
            `INSERT INTO accounts ( Name, Surname, Login, Password, Email, Rank, State, InventoryId, PersonalUseID) VALUES ('${name}','${surname}','${login}','${password}','${email}','${rank}',,'${state}','${inventoryid}','${personaluseid}')`,
            (error, results) => {
